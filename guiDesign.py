...
# R2.pack( anchor = W )
# ----
R3 = ttk.Radiobutton(RadioFrame, text="מהיר לי", variable=deliveryCompany_radioVar, value="23",
...
subTextLabel = Label(subTextFrame, text="סמס עם הזמנה לאפליקציה",
                     font=("rubik", 9), bg="#236795", fg="white").pack()
...
c1 = tk.Checkbutton(checkBoxFrame,
                    variable=checkBox_AppAdToSMS,
                    onvalue=0, offvalue=1, bg="#236795",
                    command=change_checkbox)
c1.pack()
